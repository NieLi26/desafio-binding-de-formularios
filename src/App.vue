  ...
  <div id="app">
    <form>
      ...
      <div>
        ...
        <input value="/visa.png"/>
      </div>
    </form>

    <div class="carnet">
      <h3>{{ tituloTarjeta }}</h3>
      <img width="40" :src="require(`@/assets${srcChip}`)" alt="" />
      <div>
        <h2>{{ numero }}</h2>
      ...
      <footer>
        ...
        <img :src="require(`@/assets${srcTarjeta}`)" width="60" />
      </footer>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      tituloTarjeta: 'Visa Classic Crédito',
      fechaExp: '01/30',
